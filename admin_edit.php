<?php
function valid($id, $name, $address,$city,$password,$sal, $error)
{
?>
...
if ($name == '' || $address == '' || $city == '' || $password == '' || $sal == '')
{

$error = 'ERROR: Please fill in all required fields!';


valid($id, $name, $address,$city,$password,$sal,$error);
}
else
{

$s=mysql_query("UPDATE admin SET name='$name', address='$address' ,city='$city',password='$password',sal='$sal' WHERE id='$id'");
...
$sal = $row['sal'];
valid($id, $name, $address,$city,$password,$sal,'');
}
else
{
echo "No results!";
