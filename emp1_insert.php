<?php
function valid($name, $address,$city,$password,$sal,$ml,$cl, $error)
{
?>
...
if ($name == '' || $address == '' || $city == ''|| $password == ''|| $sal == ''|| $ml == ''|| $cl == '')
{

$error = 'Please enter the details!';

valid($name, $address, $city,$password,$sal,$ml,$cl,$error);
}
else
{

mysql_query("INSERT employee SET name='$name', address='$address', city='$city', password='$password', sal='$sal', ml='$ml', cl='$cl'")
or die(mysql_error());

header("Location: emp1_view.php");
}
}
else
{
