...
echo '<td><b><font color="#663300"><a href="hr1_edit.php?id=' . $row['id'] . '">Update</a></font></b></td>';
echo '<td><b><font color="#663300"><a href="hr1_delete.php?id=' . $row['id'] . '">Delete</a></font></b></td>';
...
echo "</table>";
?>
<p><a href="hr1_insert.php">Insert new record</a></p>
